...
function copyAs(editor, ids, opts) {
  ...
  if (navigator.clipboard.write) {
    const { blobPromise, mimeType } = (0, import_export.exportToImagePromiseForClipboard)(editor, ids, imageOpts);
    const types = { [mimeType]: blobPromise };
    const additionalMimeType = (0, import_clipboard.getAdditionalClipboardWriteType)(opts.format);
  ...
  switch (opts.format) {
    ...
    default:
      (0, import_editor.exhaustiveSwitchError)(opts.format);
  }
}
