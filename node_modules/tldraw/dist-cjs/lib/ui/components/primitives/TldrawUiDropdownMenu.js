...
function TldrawUiDropdownMenuRoot({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_radix_ui.DropdownMenu.Root,
    {
      open: debugOpen || open,
      dir,
      modal,
...
function TldrawUiDropdownMenuContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.Portal, { container, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
function TldrawUiDropdownMenuSub({ id, children }) {
  const [open, onOpenChange] = (0, import_useMenuIsOpen.useMenuIsOpen)(id);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.Sub, { open, onOpenChange, children });
}
function TldrawUiDropdownMenuSubTrigger({
  ...
  const dir = (0, import_useTranslation.useDirection)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.SubTrigger, { dir, asChild: true, disabled, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_TldrawUiButton.TldrawUiButton,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiButtonIcon.TldrawUiButtonIcon, { icon: dir === "rtl" ? "chevron-left" : "chevron-right", small: true })
      ]
    }
  ) });
}
...
function TldrawUiDropdownMenuGroup({ className, children }) {
  const dir = (0, import_useTranslation.useDirection)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { dir, className: (0, import_classnames.default)("tlui-menu__group", className), children });
}
function TldrawUiDropdownMenuIndicator() {
  const msg = (0, import_useTranslation.useTranslation)();
  const dir = (0, import_useTranslation.useDirection)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.ItemIndicator, { dir, asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiIcon.TldrawUiIcon, { label: msg("ui.checked"), icon: "check" }) });
}
function TldrawUiDropdownMenuItem({ noClose, children }) {
  const dir = (0, import_useTranslation.useDirection)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.Item, { dir, asChild: true, onClick: noClose ? import_editor.preventDefault : void 0, children });
}
function TldrawUiDropdownMenuCheckboxItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_radix_ui.DropdownMenu.CheckboxItem,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "tlui-button__checkbox__indicator", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.ItemIndicator, { dir, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiIcon.TldrawUiIcon, { label: msg("ui.checked"), icon: "check", small: true }) }) }),
        children
      ]
    }
  );
