...
function TldrawUiPopoverTrigger({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.Popover.Trigger, { asChild: true, dir, children });
}
function TldrawUiPopoverContent({
  ...
  const handleOpenAutoFocus = import_react.default.useCallback(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.Popover.Portal, { container, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
