...
function OverflowingToolbar({
  ...
  (0, import_react.useEffect)(() => {
    ...
    function handleKeyDown(event) {
      if ((0, import_useKeyboardShortcuts.areShortcutsDisabled)(editor) || (0, import_editor.activeElementShouldCaptureKeys)(false, editor.getContainerDocument())) {
        return;
      }
...
function isActiveTLUiToolItem(item, activeToolId, geoState) {
