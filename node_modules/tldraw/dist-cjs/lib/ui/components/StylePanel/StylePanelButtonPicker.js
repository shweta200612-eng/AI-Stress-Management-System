...
function StylePanelButtonPickerInlineInner(props) {
  ...
  const colors = (0, import_editor.useValue)(
  ...
  const {
    ...
    const handlePointerUp = () => {
      ...
      if (origActiveEl && (0, import_editor.elementShouldCaptureKeys)(origActiveEl, false)) {
        origActiveEl.focus();
    ...
    const handleButtonPointerDown2 = (e) => {
      ...
      rPointingOriginalActiveElement.current = editor.getContainerDocument().activeElement;
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layout, { children: items.map((item) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_TldrawUiToolbar.TldrawUiToolbarToggleItem,
          {
            ...
            title: label,
            style: style === import_editor.DefaultColorStyle ? { color: (0, import_editor.getColorValue)(colors, item.value, "solid") } : void 0,
