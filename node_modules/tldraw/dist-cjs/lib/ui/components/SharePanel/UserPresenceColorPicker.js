...
const UserPresenceColorPicker = (0, import_editor.track)(function UserPresenceColorPicker2() {
  ...
  const {
    ...
    const handlePointerUp = () => {
      ...
      (0, import_editor.getOwnerWindow)(container).removeEventListener("pointerup", handlePointerUp);
    };
    ...
    const handleButtonPointerDown2 = (e) => {
      ...
      (0, import_editor.getOwnerWindow)(container).addEventListener("pointerup", handlePointerUp);
    };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_radix_ui.Popover.Root, { onOpenChange: handleOpenChange, open: isOpen, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.Popover.Trigger, { dir, asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
