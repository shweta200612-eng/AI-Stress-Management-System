...
const PageItemSubmenu = (0, import_editor.track)(function PageItemSubmenu2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_TldrawUiDropdownMenu.TldrawUiDropdownMenuRoot, { id: `page item submenu ${index}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiDropdownMenu.TldrawUiDropdownMenuContent, { side: "bottom", align: "start", alignOffset: 0, sideOffset: 0, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_TldrawUiMenuContext.TldrawUiMenuContextProvider, { type: "menu", sourceId: "page-menu", children: [
