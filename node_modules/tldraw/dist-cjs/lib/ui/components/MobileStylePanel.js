...
function MobileStylePanel() {
  ...
  const currentColor = (0, import_editor.useValue)(
    ...
    () => {
      ...
      return color?.type === "shared" ? (0, import_editor.getColorValue)(colors, color.value, "solid") : (0, import_editor.getColorValue)(colors, "black", "solid");
    },
    [editor, color]
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_TldrawUiPopover.TldrawUiPopover, { id: "mobile style menu", onOpenChange: handleStylesOpenChange, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiPopover.TldrawUiPopoverContent, { side: orientation === "horizontal" ? "top" : "right", align: "end", children: StylePanel && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StylePanel, { isMobile: true }) })
  ] });
}
