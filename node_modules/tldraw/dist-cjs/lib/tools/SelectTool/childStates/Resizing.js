...
class Resizing extends import_editor.StateNode {
  ...
  updateShapes() {
    ...
    const isHoldingAccel = (0, import_editor.isAccelKey)(editor.inputs);
    ...
    if (shapeSnapshots.size > 1) {
      (0, import_GeoShapeUtil.batchMeasureGeoLabels)(
        this.editor,
        shapeSnapshots,
        scale,
        selectionRotation,
  ...
  updateEnclosureHints() {
    ...
    const hintingShapeIds = (0, import_FrameShapeTool.getEnclosedShapeIds)(this.editor, shape);
  ...
  onExit() {
    ...
    (0, import_GeoShapeUtil.setBatchLabelSizeCache)(this.editor, null);
  ...
  _createSnapshot() {
    ...
    const getLevel = (id) => {
      ...
      while (parentId && (0, import_editor.isShapeId)(parentId)) {
