...
var getArrowInfo_exports = {};
__export(getArrowInfo_exports, {
  getArrowInfo: () => getArrowInfo
});
module.exports = __toCommonJS(getArrowInfo_exports);
...
const arrowInfoCache = (0, import_store.createComputedCache)(
  ...
  (editor, shape) => {
    ...
    const sw = "getDisplayValues" in util.options ? (0, import_getDisplayValues.getDisplayValues)(util, shape).strokeWidth : editor.getCurrentTheme().strokeWidth * import_default_shape_constants.STROKE_SIZES[shape.props.size];
    if (shape.props.kind === "elbow") {
      const elbowInfo = (0, import_getElbowArrowInfo.getElbowArrowInfo)(editor, shape, bindings, sw);
      if (!elbowInfo?.route) return (0, import_straight_arrow.getStraightArrowInfo)(editor, shape, bindings, sw);
    ...
    if ((0, import_shared.getIsArrowStraight)(shape)) {
      return (0, import_straight_arrow.getStraightArrowInfo)(editor, shape, bindings, sw);
    } else {
      return (0, import_curved_arrow.getCurvedArrowInfo)(editor, shape, bindings, sw);
    }
  },
  {
...
//# sourceMappingURL=getArrowInfo.js.map
