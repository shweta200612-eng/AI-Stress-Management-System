...
var import_PatternFill = require("../shared/PatternFill");
...
function addRoundedRectPath(path, bounds, radius, counterClockwise = false) {
  ...
  options = {
    ...
    getDefaultDisplayValues(_editor, shape, theme, colorMode) {
      ...
      return {
        ...
        labelFontSize: theme.fontSize * import_default_shape_constants.ARROW_LABEL_FONT_SIZES[size],
        labelLineHeight: theme.lineHeight,
        labelPadding: import_default_shape_constants.ARROW_LABEL_PADDING,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      showArrowLabel && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_RichTextLabel.RichTextLabel,
        {
          ...
          textWidth: (labelPosition.box.w - dv.labelPadding * 2 * shape.props.scale) / shape.props.scale,
          isSelected,
          padding: 0,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { transform: `scale(${scaleFactor})`, children: [
      ...
      showArrowLabel && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_RichTextLabel.RichTextSVG,
        {
          ...
          labelColor: dv.labelColor,
          richText: shape.props.richText,
          bounds: (0, import_arrowLabel.getArrowLabelPosition)(this.editor, shape, false).box.clone().expandBy(-dv.labelPadding * shape.props.scale),
          padding: 0,
          showTextOutline: this.options.showTextOutline
        }
      )
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "g",
      {
        ...
        children: [
          ...
          as && clipStartArrowhead && shape.props.fill !== "none" && (shape.props.fill === "pattern" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: fillColor, d: as })),
          ae && clipEndArrowhead && shape.props.fill !== "none" && (shape.props.fill === "pattern" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_PatternFill.PatternFill,
            {
              d: ae,
              fillColor,
          ...
          ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: fillColor, d: ae })),
