...
function interpolateSegments(startSegments, endSegments, progress) {
  ...
  startSegments.forEach(
    (segment) => startPoints.push(...import_editor.b64Vecs.decodePoints(segment.path, segment.dim))
  );
  endSegments.forEach(
    (segment) => endPoints.push(...import_editor.b64Vecs.decodePoints(segment.path, segment.dim))
  );
