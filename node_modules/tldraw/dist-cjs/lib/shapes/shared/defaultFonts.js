...
__export(defaultFonts_exports, {
  ...
  getThemeFontFaces: () => getThemeFontFaces
});
...
function getThemeFontFaces(theme, font) {
  const builtinFamily = `tldraw_${font}`;
  if (builtinFamily in DefaultFontFaces) return void 0;
  const themeFont = theme.fonts[font];
  ...
  return themeFont?.faces ?? import_editor.EMPTY_ARRAY;
}
