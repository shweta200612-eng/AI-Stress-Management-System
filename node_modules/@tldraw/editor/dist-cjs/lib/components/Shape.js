...
const Shape = (0, import_react.memo)(function Shape2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ShapeWrapper, { ref: containerRef, shape, isBackground: false, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ErrorBoundary.OptionalErrorBoundary, { fallback: ShapeErrorFallback, onError: annotateError, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InnerShape, { shape, util }) }),
      util.getAppOwnedElement && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContentElementSlot, { id, util })
    ] })
  ] });
});
const ContentElementSlot = (0, import_react.memo)(function ContentElementSlot2({
  id,
  util
}) {
  const editor = (0, import_useEditor.useEditor)();
  ...
  (0, import_react.useLayoutEffect)(() => {
    ...
    if (element.parentNode !== slot) {
      (0, import_dom.moveElementInto)(slot, element);
    }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: slotRef, className: "tl-content-slot", draggable: false });
});
function warnIfContentElementReloads(editor, slot, element) {
  const onLoad = (event) => {
  ...
  editor.timers.setTimeout(() => slot.removeEventListener("load", onLoad, { capture: true }), 1e3);
}
