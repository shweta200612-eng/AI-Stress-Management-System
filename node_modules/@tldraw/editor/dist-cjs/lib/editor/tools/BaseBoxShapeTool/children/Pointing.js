...
var import_cancelShapeCreationOnLongPress = require("../../cancelShapeCreationOnLongPress");
...
class Pointing extends import_StateNode.StateNode {
  ...
  onLongPress() {
    (0, import_cancelShapeCreationOnLongPress.cancelShapeCreationOnLongPress)(this.editor, () => this.cancel());
  }
  onCancel() {
    this.cancel();
  }
