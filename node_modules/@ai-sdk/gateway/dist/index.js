...
function extractApiCallResponse(error) {
  ...
  if (error.responseBody != null) {
    try {
      return (0, import_provider_utils3.secureJsonParse)(error.responseBody);
    } catch (e) {
...
var gatewayAuthMethodSchema = (0, import_provider_utils4.lazySchema)(
  () => (0, import_provider_utils4.zodSchema)(import_v43.z.union([import_v43.z.literal("api-key"), import_v43.z.literal("oidc")]))
);
...
var gatewayAvailableModelsResponseSchema = (0, import_provider_utils5.lazySchema)(
...
var gatewayCreditsResponseSchema = (0, import_provider_utils5.lazySchema)(
  () => (0, import_provider_utils5.zodSchema)(
    import_v44.z.object({
  ...
  async doGenerate(options) {
    ...
    try {
      const {
        ...
        body: args,
        successfulResponseHandler: (0, import_provider_utils8.createJsonResponseHandler)(import_v47.z.any()),
  ...
  async doStream(options) {
    ...
    try {
      const { value: response, responseHeaders } = await (0, import_provider_utils8.postJsonToApi)({
        ...
        body: args,
        successfulResponseHandler: (0, import_provider_utils8.createEventSourceResponseHandler)(import_v47.z.any()),
        failedResponseHandler: (0, import_provider_utils8.createJsonErrorResponseHandler)({
          errorSchema: import_v47.z.any(),
          errorToMessage: (data) => data
        }),
...
var gatewayEmbeddingResponseSchema = (0, import_provider_utils9.lazySchema)(
    ...
    try {
      const { responseHeaders, value: responseBody } = await (0, import_provider_utils11.postJsonToApi)({
        ...
        successfulResponseHandler: async ({
          ...
          const eventStream = (0, import_provider_utils11.parseJsonEventStream)({
...
var gatewayRerankingResponseSchema = (0, import_provider_utils12.lazySchema)(
  ...
  async doGenerate({
    ...
    try {
      const {
        ...
        body: {
          audio: audio instanceof Uint8Array ? (0, import_provider_utils14.convertUint8ArrayToBase64)(audio) : audio,
          mediaType,
          ...providerOptions && { providerOptions }
        },
...
var exaSearchInputSchema = (0, import_provider_utils15.lazySchema)(
...
var exaSearchOutputSchema = (0, import_provider_utils15.lazySchema)(
  () => (0, import_provider_utils15.zodSchema)(
    import_zod.z.union([
      import_zod.z.object({
...
var exaSearchToolFactory = (0, import_provider_utils15.createProviderToolFactoryWithOutputSchema)({
...
var parallelSearchInputSchema = (0, import_provider_utils16.lazySchema)(
...
var parallelSearchOutputSchema = (0, import_provider_utils16.lazySchema)(
  () => (0, import_provider_utils16.zodSchema)(
    import_zod2.z.union([
      // Success response
      import_zod2.z.object({
...
var parallelSearchToolFactory = (0, import_provider_utils16.createProviderToolFactoryWithOutputSchema)({
...
var perplexitySearchInputSchema = (0, import_provider_utils17.lazySchema)(
...
var perplexitySearchOutputSchema = (0, import_provider_utils17.lazySchema)(
  () => (0, import_provider_utils17.zodSchema)(
    import_zod3.z.union([
      // Success response
      import_zod3.z.object({
...
var perplexitySearchToolFactory = (0, import_provider_utils17.createProviderToolFactoryWithOutputSchema)({
...
function createGatewayProvider(options = {}) {
  ...
  let lastFetchTime = 0;
  const baseURL = (_b11 = (0, import_provider_utils18.withoutTrailingSlash)(options.baseURL)) != null ? _b11 : "https://ai-gateway.vercel.sh/v3/ai";
  const getHeaders = async () => {
    try {
      const auth = await getGatewayAuthToken(options);
      return (0, import_provider_utils18.withUserAgentSuffix)(
        {
  ...
  const createO11yHeaders = () => {
    const deploymentId = (0, import_provider_utils18.loadOptionalSetting)({
      settingValue: void 0,
      environmentVariableName: "VERCEL_DEPLOYMENT_ID"
    });
    const environment = (0, import_provider_utils18.loadOptionalSetting)({
      settingValue: void 0,
      environmentVariableName: "VERCEL_ENV"
    });
    const region = (0, import_provider_utils18.loadOptionalSetting)({
      settingValue: void 0,
      environmentVariableName: "VERCEL_REGION"
    });
    const projectId = (0, import_provider_utils18.loadOptionalSetting)({
      settingValue: void 0,
...
async function getGatewayAuthToken(options) {
  const apiKey = (0, import_provider_utils18.loadOptionalSetting)({
